from ansible_second_gen_commands.commands.utility.gitlab_api_url_validator import is_base_path_gitlab_api
from ansible_second_gen_commands.commands.utility.sandbox_reporter import SandboxReporter
from ansible_second_gen_commands.commands.utility.shell_connector_helpers import get_connector_endpoints
from ansible_second_gen_commands.commands.utility.validate_protocols import is_path_supported_protocol
from ansible_second_gen_commands.exceptions.exceptions import AnsibleSecondGenServiceException
from ansible_second_gen_commands.models.ansible_config_from_cached_json import get_cached_ansible_config_from_json
from ansible_second_gen_commands.service_globals import user_pb_params, override_attributes
...
class AnsibleSecondGenLogic(object):
    ...
    def get_linked_resources(self, api, service_name, res_id, connectors, config_selector, reporter):
       ...
       :return:
       """
        connector_resources = self._get_resources_from_connectors(api, service_name, connectors)
    ...
    def build_repo_url(self, service_full_url, service_url_base_path, service_pb_relative_path, playbook_path_input,
        ...
        if is_path_supported_protocol(playbook_path_input, supported_protocols):
        ...
        if service_url_base_path.endswith("/"):
            url = service_url_base_path + playbook_path_input
        else:
            url = service_url_base_path + "/" + playbook_path_input
